...
- [Guiding Pseudo-labels with Uncertainty Estimation for Test-Time Adaptation](https://arxiv.org/abs/2303.03770). Reweight the loss based on the uncertainty (reliability) of the pseudo-labels; Refine pseudo labels by aggragating knoledge from neighboring samples.
